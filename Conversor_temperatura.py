...
def create_temperaturas_widget(ventana):
    ...
    boton_borrar = ttk.Button(frame, text="Borrar", command=borrar_cajas(caja_temp_cel, caja_temp_kelvin, caja_temp_farenheit))
    boton_borrar.place(x=100, y=250)
    ...
    boton_convertir = ttk.Button(frame, text="Convertir", command=lambda: convertir() 
    ...
    boton_convertir.place(x=20, y=250)
